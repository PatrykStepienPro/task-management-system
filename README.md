...
![CI](https://img.shields.io/github/actions/workflow/status/PatrykStepienPro/task-management-system/ci.yml?branch=master&label=CI&logo=githubactions&logoColor=white)
![Docker Build](https://img.shields.io/github/actions/workflow/status/PatrykStepienPro/task-management-system/docker.yml?branch=master&label=Docker+Build&logo=docker&logoColor=white)
